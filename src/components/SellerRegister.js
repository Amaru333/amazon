...
function SellerRegister() {
  ...
  const registerUser = () => {
    Axios.post("https://amaru-amazon.herokuapp.com/createSeller", {
      ...
      if (response.data.error) {
        ...
        setTimeout(() => history.push("/seller/login"), 300);
      }
    });
  };
  ...
  return (
    <div className="registerPage">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Register a new seller account</title>
      </Helmet>
      ...
      <div className="innerBox">
        <div className="innerElements">
          <h1>Create a new seller account</h1>
          ...
          <span className="terms">
            By creating an seller account in our website, you are agreeing to
      ...
      <div className="register">
        <div className="aDivider">
          <h5>
            <span className="line">Already have a seller account?</span>
          </h5>
        </div>
